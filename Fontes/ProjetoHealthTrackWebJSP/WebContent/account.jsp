				...
				<div class="col-md-11">
					<div class="container-fluid conteudo">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label for="nomeCompleto">Nome completo</label> <input
										type="text" class="form-control" id="nomeCompleto" required>
								</div>
								<div class="form-group">
							...
							<div class="col-md-4">
								<div class="form-group">
									<label for="dataNascimento">Qual sua data de
										nascimento?</label> <input type="text"
										class="form-control tipoCalendario" id="dataNascimento"
										required>
								</div>
								<div class="form-group">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Trocar senhar?
						Parece uma boa idéia!</h4>
				</div>
