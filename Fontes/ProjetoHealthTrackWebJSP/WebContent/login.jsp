                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control tipoEmail" id="login" required>                                                
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 rememberPassword text-right">
                                            <span>
                                                <a href="rememberPassword.html">Esqueci a senha</a>
                                            </span>  
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <a href="dashboard.jsp" class="btn btn-primary" id="btnEntrar">
                                                Entrar
                                            </a>
                                        </div>                                        
                                    </div>
